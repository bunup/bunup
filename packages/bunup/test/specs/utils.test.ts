...
import { getResolvedDefine, getResolvedMinify, getResolvedSplitting } from "../../src/options";
...
describe("Utils", () => {
	...
	describe("getDefaultDtsOutputExtention", () => {
		it("returns .d.mts for esm format without module type", () => {
			expect(getDefaultDtsOutputExtention("esm", undefined, "entry-point")).toBe(".d.mts");
		});
		it("returns .d.ts for esm format with module type", () => {
			expect(getDefaultDtsOutputExtention("esm", "module", "entry-point")).toBe(".d.ts");
		});
		it("returns .d.cts for cjs format with module type", () => {
			expect(getDefaultDtsOutputExtention("cjs", "module", "entry-point")).toBe(".d.cts");
		});
		it("returns .d.ts for cjs format with commonjs type", () => {
			expect(getDefaultDtsOutputExtention("cjs", "commonjs", "entry-point")).toBe(".d.ts");
		});
		it("returns .d.ts for iife format", () => {
			expect(getDefaultDtsOutputExtention("iife", undefined, "entry-point")).toBe(".global.d.ts");
		});
		it("returns .d.ts for chunk files", () => {
			expect(getDefaultDtsOutputExtention("esm", undefined, "chunk")).toBe(".d.ts");
		});
	});
	...
	describe("cleanPath", () => {
		...
		it("handles complex paths with multiple transformations", () => {
			expect(cleanPath("D:\\\\multiple\\//slashes//\\file.js")).toBe("multiple/slashes/file.js");
		});
		...
		it("handles mixed slashes", () => {
			expect(cleanPath("path\\to/mixed\\slashes.js")).toBe("path/to/mixed/slashes.js");
		});
